    ...
    def _create_window_executor(self, window: WindowExecutionState, workflow_data: dict):
        ...
        try:
            ...
            executor, process_thread = create_process_workflow_runtime(
                ...
                live_runtime_persistence=not bool(
                    workflow_data.get("_disable_live_runtime_persistence", False)
                ),
                ...
                source_workflow_task_keys=workflow_data.get(
                    "_source_workflow_task_keys"
                ),
                parent=None,
            )
